var tweditor = (function() {
  ...
  setup_editor = function() {
    ...
    $('.tweditor').width(textarea.width());
    editor.setSize(textarea.width(),
...
/*
  init_handlers = function() {
    ...
    splitScreenButton.on("click", function() {
      editor_view.addClass("fullscreen").removeClass("view-mode").removeClass("edit-mode");  
      editor.refresh(); //not documented
    });
    editButton.on("click", function() {
      editor_view.removeClass("fullscreen").removeClass("view-mode").addClass("edit-mode");  
      editor.refresh();
    });
    viewButton.on("click", function() {
      editor_view.removeClass("fullscreen").addClass("view-mode").removeClass("edit-mode");  
      editor.refresh();
    });
